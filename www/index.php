  ...
  <head>
    ...
    <div class = "col-xs-10">
      <div class="mainBody container-fluid" >
        ...
        <!--Section 2 Quick intro info + picutre stuff-->
        ...
        <div class="container-fluid" >
          <div class="row">
            ...
            <div class="col-sm-8">
              ...
              <div class="center">
                <button id="forwardButton" type="button" class="btn-lg btn-default" onclick="backward()" aria-label="Backward">
                    <i class="glyphicon glyphicon-chevron-left" aria-hidden="true"></i>
                </button>
                <button type="button" class="btn-lg btn-default" onclick="pause()" aria-label="Pause">
                    <i id="pauseButton" class="glyphicon glyphicon-pause" aria-hidden="true"></i>
                </button>
                <button id="backwardButton" type="button" class="btn-lg btn-default" onclick="forward()" aria-label="Forward">
